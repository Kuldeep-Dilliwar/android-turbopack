...
yes | npx create-next-app@v16.2.1-canary.38 my-app --yes && clear && \
cd my-app && clear && \
wget https://github.com/Kuldeep-Dilliwar/next.js/releases/download/v16.2.1-canary.38-android/next-swc-binaries-aarch64-linux-android.zip && clear && \
