...
yes | npx create-next-app@v16.2.0-canary.8 my-app --yes && clear && \
cd my-app && clear && \
wget https://github.com/Kuldeep-Dilliwar/next.js/releases/download/v16.2.0-canary.8-android/next-swc-binaries-aarch64-linux-android.zip && clear && \
